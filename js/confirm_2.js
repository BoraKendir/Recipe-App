function confirm_2(element, ingredients) {
    return new Promise((resolve, reject) => {
        ...
        button.addEventListener("click", function() {
            const IngredientList = [
                'Beef', 'Bread', 'Broccoli', 'Butter', 'Carrot', 'Cheddar Cheese', 'Chicken', 'Cucumber', 
                'Egg', 'Eggplant', 'Fish', 'Garlic', 'Lettuce', 'Mushroom', 'Onion', 'Potato', 
                'Red Bell Pepper', 'Stuffed Bell Pepper', 'Tomato', 'Zucchini'
            ];
